...
- [ ] **Step 1: Write failing tests for raw dominance evidence and all-false advisory transport**
...
- [ ] **Step 3: Implement the minimal evidence and advisory behavior**
...
- [ ] **Step 4: Run focused model/grounder tests**
...
- [ ] **Step 1: Write failing temporal graph tests**
...
- [ ] **Step 2: Write failing certificate-envelope tests**
...
- [ ] **Step 4: Implement the minimal temporal tracker**
...
- [ ] **Step 5: Implement schema-aware certificate reconciliation**
...
- [ ] **Step 6: Wire one tracker instance into each Shadow runtime**
...
- [ ] **Step 7: Run the focused Shadow test modules**
...
- [ ] **Step 1: Write a failing isolated-settling callback test**
...
- [ ] **Step 2: Write a failing runtime terminal-regression test**
...
- [ ] **Step 4: Implement contained settling callbacks**
...
- [ ] **Step 5: Connect settling samples to the same tracker**
...
- [ ] **Step 6: Run protocol and Shadow tests**
...
**Files:**
- Modify: `results/logiv-three-arm-random100-20260804.json`
- Modify: `results/logiv-three-arm-random100-20260804.md`
- Create: `runs/shadow-logiv-random100-temporal-20260805/` runtime artifacts (ignored)
...
- [ ] **Step 2: Launch the two existing policy-server shards**
...
- [ ] **Step 3: Run only new SHADOW_LOGIV cases from the frozen manifest**
...
mode, 10 settling steps, and original policy-server shard.  Write into the new
run directory and do not rerun Base or legacy full intervention.

- [ ] **Step 4: Audit every paired case**

Compare each new Shadow `base_execution.json` with the saved Base record.  The
...
- [ ] **Step 5: Compute terminal topology results**
...
- [ ] **Step 6: Update the result report and commit**

Run: `git add results/logiv-three-arm-random100-20260804.json results/logiv-three-arm-random100-20260804.md docs/superpowers/specs/2026-08-05-shadow-temporal-topology-design.md docs/superpowers/plans/2026-08-05-shadow-temporal-topology.md && git commit -m "results(logiv): validate temporal shadow topology"`

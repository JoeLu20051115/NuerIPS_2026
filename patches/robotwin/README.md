...
Apply these patches to the TACO checkout in the exact order below. The numeric
prefixes restart because the patches were exported at successive development
checkpoints; this list is authoritative.
